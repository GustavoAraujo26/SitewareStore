...
namespace SitewareStore.Tests.ServiceTests.Promotion
{
    public class DeletePromotionServiceTests
    {
        ...
        public async Task ShouldReturnSuccess()
        {
            ...
            services.AddTransient(mock => ProductRepositoryMock.BuildFailure_For_ListProductNames().Object);
            services.AddTransient(mock => RepositoryBaseMock.Build().Object);

            var productService = services.GetService<IDeletePromotionService>();
        ...
        [Fact]
        public async Task ShouldReturnFailure_For_LinkedProducts()
        {
            var services = ServiceCollectionBuilder.BuildServiceCollection();
