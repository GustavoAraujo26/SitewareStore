...
{
    public class ListPromotionServiceTests
    {
        [Fact]
        public async Task ShouldReturnSuccess()
        {
            ...
            var productService = services.GetService<IListPromotionService>();
        ...
        public async Task ShouldReturnFailure_For_Exception()
        {
            ...
            services.AddTransient(mock => PromotionRepositoryMock.BuildFailure_For_ExceptionOnListAll().Object);
            services.AddTransient(mock => RepositoryBaseMock.Build().Object);
